...
const Navbar = () => {
    ...
    const renderMobileCategoryMenu = () => (
        <div
            className={`mobile-category-menu ${showMobileCategoryMenu ? 'open' : ''}`}
        >
    ...
    const renderSearchBar = () =>
        showSearch ? (
            <form
                ...
                className="flex items-center gap-2 border border-gray-300 rounded-full px-4 py-1.5 bg-white shadow-sm"
            >
    ...
    return (
        <>
            ...
            {/* Main Navbar */}
            <nav
                className={`navbar-wrapper ${isVisible ? 'navbar-visible' : 'navbar-hidden'}`}
            >
