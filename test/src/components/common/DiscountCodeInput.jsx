...
const DiscountCodeInput = ({ orderTotal, onDiscountApplied }) => {
    ...
    return (
        <div className="discount-code-section">
                        ...
                        <div className="discount-applied-info">
                            ...
                            {appliedCode.usageLimit && (
                                <p className="discount-usage-info">
                                    {getRemainingUses(appliedCode)} uses
                                    remaining
                                </p>
                            )}
                        </div>
            ...
            <AlertDialog
                open={showAvailableCodes}
                onOpenChange={setShowAvailableCodes}
            >
                    ...
                    <div className="available-codes-list">
                        {codes.length === 0 ? (
                            <p className="no-codes-message">
                                No discount codes available at the moment.
                            </p>
                        ) : (
                            codes.map((codeObj) => {
                                const discount =
                                    typeof codeObj.value === 'object'
                                        ? parseFloat(
                                              codeObj.value.$numberDecimal ||
                                                  codeObj.value,
                                          )
