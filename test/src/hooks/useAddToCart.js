        ...
        try {
            ...
            if (hasVariants && !variant) {
                toast.error('Please select a variant', {
                    description:
                        'This product has multiple options. Please select one before adding to cart.',
                });
                return false;
            }
            ...
            console.log(
                '[ADD TO CART] Completed in',
                (performance.now() - addStartTime).toFixed(0),
                'ms',
            );
