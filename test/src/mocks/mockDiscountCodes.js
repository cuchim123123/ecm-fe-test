 ...
 * - code: String (8-12 chars for new codes, uppercase, unique, required)
 *         (legacy 5-char codes kept here for backward-compat scenarios)
 * - value: Decimal128 (discount amount in VND)
 * - usageLimit: Number (max 10, min 1)
 * - usedCount: Number (default 0, min 0)
 * - createdBy: ObjectId (FK → User, admin only)
