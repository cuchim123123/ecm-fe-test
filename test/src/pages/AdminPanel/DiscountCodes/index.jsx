    ...
    const fetchCodes = async () => {
        try {
            ...
            if (
                ...
                toast.error(
                    'Discount codes feature not available yet. Backend endpoint missing.',
                );
            } else if (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {filteredCodes.map((code) => {
                                ...
                                return (
                                    <Card
                                        key={code._id}
                                        className={`hover:shadow-md transition-shadow ${isFullyUsed ? 'opacity-60' : ''}`}
                                    >
