        ...
        <div className="border-2 border-gray-300 dark:border-gray-600 rounded-lg p-5 space-y-4 bg-gray-50 dark:bg-gray-800">
            <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                    Create attributes (like Color, Size) and add values to each.
            ...
            <div className="flex gap-2">
                <Input
                    ...
                    onKeyPress={(e) =>
                        e.key === 'Enter' &&
                        (e.preventDefault(), addAttributeDefinition())
                    }
                />
                <Button
                    type="button"
            ...
            {attributeDefinitions.length === 0 ? (
                ...
                attributeDefinitions.map((attr, attrIndex) => (
                    <div
                        key={attrIndex}
                        className="space-y-3 p-4 bg-white dark:bg-gray-700 rounded-lg border-2 border-blue-200 dark:border-blue-800 shadow-sm"
                    >
                        <div className="flex items-center justify-between">
                            <div>
                            ...
                            <Button
                                ...
                                size="sm"
                                onClick={(e) =>
                                    removeAttributeDefinition(e, attrIndex)
                                }
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button
                                ...
                                disabled={
                                    !attributeValueInputs[attrIndex]?.trim()
                                }
                            >
                                <Plus className="w-4 h-4 mr-1" />
                                Add
