                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-4 mb-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="minPrice:asc">
                                        Price (Low to High)
                                    </SelectItem>
                                    <SelectItem value="minPrice:desc">
                                        Price (High to Low)
                                    </SelectItem>
                                    <SelectItem value="averageRating:desc">
                                        Highest Rated
                                    </SelectItem>
                                    <SelectItem value="totalUnitsSold:desc">
                                        Most Sold
                                    </SelectItem>
                                </SelectContent>
                            </Select>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                value={filters.daysAgo || 'all'}
                                onValueChange={(v) =>
                                    handleChange('daysAgo', v)
                                }
                            >
                                <SelectTrigger>
