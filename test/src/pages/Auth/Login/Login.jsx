                    ...
                    <CardContent>
                        ...
                        >
                            <div className="space-y-2">
                                <Label
                                    htmlFor="forgotEmail"
                                    className="text-sm font-semibold text-white [text-shadow:_0_1px_2px_rgb(0_0_0_/_50%)]"
                                >
                                    Email Address
                                </Label>
                                <Input
                    ...
                    <CardContent className="space-y-6">
                        <form onSubmit={handleOtpVerify} className="space-y-6">
                            <div className="space-y-3">
                                <Label className="text-sm font-semibold text-white [text-shadow:_0_1px_2px_rgb(0_0_0_/_50%)] text-center block">
                ...
                <Card className="w-full max-w-[500px] mx-auto shadow-2xl border border-white/20 bg-white/10 backdrop-blur-xl animate-in fade-in duration-500">
                    ...
                    <CardFooter className="flex flex-col gap-2 pt-6 border-t border-white/20">
                        <p className="text-sm text-center text-white/80 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">
                            ...
                            <Link
                                to="/register"
                                className="font-semibold text-white hover:underline [text-shadow:_0_1px_2px_rgb(0_0_0_/_50%)]"
                            >
                                Create one now
                            </Link>
                        </p>
