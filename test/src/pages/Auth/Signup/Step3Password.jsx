    ...
    return (
        <div className="space-y-5">
            <div className="text-center mb-4">
                <h3 className="text-lg font-semibold text-white [text-shadow:_0_1px_2px_rgb(0_0_0_/_50%)]">
                    Secure Your Account
                </h3>
                ...
                {formData.password && passwordStrength && (
                    <div className="space-y-2 animate-in slide-in-from-top-2">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs">
                            <div
                                className={`flex items-center gap-1 ${passwordStrength.checks.length ? 'text-green-300' : 'text-white/40'}`}
                            >
                            ...
                            <div
                                className={`flex items-center gap-1 ${passwordStrength.checks.uppercase ? 'text-green-300' : 'text-white/40'}`}
                            >
                            ...
                            <div
                                className={`flex items-center gap-1 ${passwordStrength.checks.lowercase ? 'text-green-300' : 'text-white/40'}`}
                            >
                            ...
                            <div
                                className={`flex items-center gap-1 ${passwordStrength.checks.number ? 'text-green-300' : 'text-white/40'}`}
                            >
