                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 space-y-4 border border-white/20">
                        <div className="flex items-start gap-3">
                            <div className="flex-shrink-0 w-6 h-6 bg-white/30 rounded-full flex items-center justify-center text-white text-sm font-bold mt-0.5">
                                1
                            </div>
                            <div>
                                <p className="font-semibold text-white [text-shadow:_0_1px_3px_rgb(0_0_0_/_50%)]">
                                    Check your inbox
                                </p>
                    ...
                    <div className="flex items-center justify-center gap-2 text-sm">
                        ...
                        <span className="text-white/80 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">
                            Link expires in{' '}
                            <span className="font-mono font-semibold text-white [text-shadow:_0_1px_2px_rgb(0_0_0_/_50%)]">
