...
const OrderDetail = () => {
    ...
    const { currentOrder, loading, error, fetchOrderById, cancelCurrentOrder } =
        useOrders();
                ...
                <div className="order-info-card">
                    ...
                    <div className="order-info-grid">
                        ...
                        <div className="info-item">
                            ...
                            <span
                                className={`info-value status-${status.color}`}
                            >
                                {status.label}
                            </span>
                        </div>
                        ...
                        {pointsUsed > 0 && (
                            <div className="info-item">
                                ...
                                <span className="info-value">
                                    {pointsUsed} pts (-{formatPrice(pointsUsed)}
                                    )
                                </span>
                            </div>
                        )}
                    ...
                    <div className="order-info-card">
                        ...
                        <div className="address-info">
                            <p className="address-name">
                                {order.addressId.fullNameOfReceiver || 'N/A'}
                            </p>
                            <p className="address-phone">
                                {order.addressId.phone || 'N/A'}
                            </p>
                            <p className="address-street">
                                {order.addressId.addressLine || 'N/A'}
                            </p>
                            {order.addressId.lat && order.addressId.lng && (
                                <p className="address-location">
                                    Coordinates: {order.addressId.lat},{' '}
                                    {order.addressId.lng}
                                </p>
                            )}
                        </div>
                        ...
                        <div className="shipping-info">
                            ...
                            {order.shipping.distance && (
                                <div className="info-item">
                                    ...
                                    <span className="info-value">
                                        {order.shipping.distance.toFixed(2)} km
                                    </span>
                                </div>
                            )}
                        ...
                        {order.payment && (
                            <>
                                <div className="info-item">
                                    ...
                                    <span
                                        className={`info-value ${order.payment.status === 'completed' ? 'text-success' : 'text-warning'}`}
                                    >
                                    ...
                                    {order.history.map((entry, index) => {
                                        ...
                                        return (
                                            <tr key={entry._id || index}>
                                                <td>
                                                    <div
                                                        className={`status-badge status-${historyStatus.color}`}
                                                    >
                                                        <HistoryIcon
                                                            size={14}
                                                        />
