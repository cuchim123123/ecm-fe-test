...
const Payment = () => {
        ...
        try {
            ...
            if (orderPaymentMethod === 'vietqr' && !order.isPaid) {
                ...
                if (zaloPayData.success && zaloPayData.zaloPay) {
                    const url =
                        zaloPayData.zaloPay.order_url ||
                        zaloPayData.zaloPay.orderurl;
                    if (url) {
    ...
    const handleConfirmPayment = async () => {
        try {
            ...
            alert(
                'Payment confirmation sent! Admin will verify and confirm your payment.',
            );
        } catch (err) {
    ...
    if (resultCode || paymentStatus) {
        ...
        return (
            <div className="payment-result">
                <div
                    className={`payment-result-card ${isSuccess ? 'success' : 'failed'}`}
                >
                    {isSuccess ? (
                        <>
                            <CheckCircle
            ...
            <div className="payment-container">
                <div className="payment-card">
                    <div className="payment-header">
                        ...
                        <p>
                            Scan QR code with your banking app to complete
                            payment
                        </p>
                    </div>
                    ...
                    <div className="payment-note">
                        <p>
                            ⚠️ After transferring, click "I've Transferred"
                            button.
                        </p>
                        <p>
                            Admin will verify your payment and confirm your
                            order.
                        </p>
                    </div>
                </div>
