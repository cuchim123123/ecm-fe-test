...
const ProductFilterSidebar = lazy(
    () => import('./components/ProductFilterSidebar'),
);
    ...
    return (
        <div className="products-page">
            <div className="products-container">
                ...
                <Suspense
                    fallback={
                        <div className="h-[60px] bg-gray-100 animate-pulse rounded" />
                    }
                >
                    <ProductToolbar
                ...
                <div
                    className={`products-content ${!showFilters ? 'filters-hidden' : ''}`}
                >
                    {/* Filters Sidebar */}
                    <Suspense
                        fallback={
                            <div className="w-[280px] h-screen bg-gray-100 animate-pulse" />
                        }
                    >
                    ...
                    <main className="products-main">
                        <Suspense
                            fallback={
                                <div className="h-[600px] bg-gray-50 animate-pulse rounded-lg" />
                            }
                        >
                            <ProductGrid
                                products={products}
